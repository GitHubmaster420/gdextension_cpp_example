extends Node
class_name LimbJoyConAttatchment

@export var limb_node : KinectJoint
...
func calibrate_joycon(jc : JoyCon):
	...
	copy_modifier_pose.reference_basis = limb_node.global_basis
...
func _ready() -> void:
	...
	ref_basis_left = Basis.from_euler(reference_object.global_rotation)* Basis.FLIP_Z * Basis.FLIP_Y
